            ...
            <div class="row justify-content-between">
                <div class="col-lg-5">
                    <div class="intro-excerpt">
                        ...
                        <p>
                            <a href="pages/login.php" class="btn btn-secondary me-2">Shop Now</a>
                    ...
                    <div class="carousel-item active">
                        <div class="row justify-content-center g-5">
                            <div class="col-lg-3 col-md-4 mb-4">
                                <div class="team-member text-center category-card">
                                    <a class="category-item" href="category.html">
                                        <img src="../public/images/beds.png" class="img-fluid" alt="Beds">
                            ...
                            <div class="col-lg-3 col-md-4 mb-4">
                                <div class="team-member text-center category-card">
                                    <a class="category-item" href="category.html">
                                        <img src="../public/images/cafe_furniture.jpeg" class="img-fluid"
                                             alt="Café Furniture">
                            ...
                            <div class="col-lg-3 col-md-4 mb-4">
                                <div class="team-member text-center category-card">
                                    <a class="category-item" href="category.html">
                                        <img src="../public/images/chairs.jpeg" class="img-fluid" alt="Chairs">
                            ...
                            <div class="col-lg-3 col-md-4 mb-4">
                                <div class="team-member text-center category-card">
                                    <a class="category-item" href="category.html">
                                        <img src="../public/images/nursery_furniture.jpeg" class="img-fluid"
                    ...
                    <div class="carousel-item">
                        <div class="row justify-content-center g-5">
                            <div class="col-lg-3 col-md-4 mb-4">
                                <div class="team-member text-center category-card">
                                    <a class="category-item" href="category.html">
                                        <img src="../public/images/gaming_furniture.png" class="img-fluid"
                            ...
                            <div class="col-lg-3 col-md-4 mb-4">
                                <div class="team-member text-center category-card">
                                    <a class="category-item" href="category.html">
                                        <img src="../public/images/outdoor_furniture.jpeg" class="img-fluid"
                            ...
                            <div class="col-lg-3 col-md-4 mb-4">
                                <div class="team-member text-center category-card">
                                    <a class="category-item" href="category.html">
                                        <img src="../public/images/sofas.jpeg" class="img-fluid" alt="Sofas">
                            ...
                            <div class="col-lg-3 col-md-4 mb-4">
                                <div class="team-member text-center category-card">
                                    <a class="category-item" href="category.html">
                                        <img src="../public/images/tables_desks.jpeg" class="img-fluid"
                                             alt="Tables & Desks">
                    ...
                    <div class="carousel-item">
                        <div class="row justify-content-center g-5">
                            <div class="col-lg-3 col-md-4 mb-4">
                                <div class="team-member text-center category-card">
                                    <a class="category-item" href="category.html">
                                        <img src="../public/images/room_dividers.jpeg" class="img-fluid"
                                             alt="Room Dividers">
                            ...
                            <div class="col-lg-3 col-md-4 mb-4">
                                <div class="team-member text-center category-card">
                                    <a class="category-item" href="category.html">
                                        <img src="../public/images/trolleys.jpeg" class="img-fluid" alt="Trolleys">
